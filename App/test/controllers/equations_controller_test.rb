...
class EquationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equation" do
    assert_difference('Equation.count') do
      post equations_url, params: { equation: { root1: @equation.root1, root2: @equation.root2 } }
    end
  ...
  test "should update equation" do
    patch equation_url(@equation), params: { equation: { root1: @equation.root1, root2: @equation.root2 } }
